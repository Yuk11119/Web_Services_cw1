...
with PdfPages(OUT) as pdf:
    page1 = [
        ...
        "API documentation: https://github.com/Yuk11119/Web_Services_cw1/blob/main/docs/api_documentation.pdf",
        "Presentation link: https://github.com/Yuk11119/Web_Services_cw1/blob/main/docs/presentation_slides.pptx",
        "",
        "## 1. Project Overview",
